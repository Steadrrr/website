...
const SITEMAP_DESC = [
    ...
    'daily'      => '일일 업무일지 작성·결재',
    'sales'      => '입장권·객실·시설대관 판매와 지역상품권 환급을 매일 보고',
    'voucher'    => '지역상품권 입고·환급 수불부와 현재고',
    'stats'      => '매출 기간별·월별·연간 통계, 업무일지 모아보기 (엑셀·인쇄)',
    'room_stats' => '객실 판매·입실인원·가동률·평균 객실단가를 일간·주간·월간·연간으로, 두 기간 비교 (엑셀·인쇄)',
    'complaints' => '업무일지에 입력한 민원을 일자·주·월별로 조회, 처리상태 변경·완료 처리, 월별 분류·객실별 통계',
...
const SITEMAP_SETTINGS_DESC = [
    'general'   => '상위 부서·사업장 이름, 프로그램 1인 참가비(유료·할인)',
    'org'       => '팀과 반 만들기·이름·순서',
    'users'     => '가입 승인, 직급·팀·반·보직, 근무 설정, 메뉴 권한, 비밀번호 초기화',
    'products'  => '입장권·객실·시설대관·대관 숙박시설 요금, 할인율, 상품권 환급액, 기간요금',
