...
(function () {
  ...
  const fee = parseInt(form.dataset.fee, 10) || 0;
  ...
  function recalc() {
    ...
    const sum = { total: 0, m: 0, f: 0, paid: 0, free: 0, amount: 0 };
